...
OUT_CSV = "reports/search_npz_scorebase_refine_v9.csv"
OUT_SUMMARY = "reports/search_npz_scorebase_refine_v9.txt"
...
STAGE1_CFGS = [
    {"alpha": 15, "threshold": 0.60, "alloc": 0.9998, "gap_min": -0.0010, "gap_max": 0.0255, "max_broken_rate": 0.412, "min_red_rate": 0.287, "max_pullback": 0.065},
...
STAGE2_THRESHOLD = [0.60, 0.62, 0.64, 0.66, 0.68]
