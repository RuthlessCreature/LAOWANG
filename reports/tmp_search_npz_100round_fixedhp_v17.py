...
OUT_CSV = "reports/search_npz_100round_fixedhp_v17.csv"
OUT_SUMMARY = "reports/search_npz_100round_fixedhp_v17.txt"
...
def main() -> None:
    rng = random.Random(202603040720)
    data = prepare_data()
