...
OUT_CSV = "reports/search_npz_100round_fixedhp_v16.csv"
OUT_SUMMARY = "reports/search_npz_100round_fixedhp_v16.txt"
...
def main() -> None:
    rng = random.Random(202603040620)
    data = prepare_data()
